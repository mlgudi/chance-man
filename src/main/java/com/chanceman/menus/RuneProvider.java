...
public enum RuneProvider
{
	...
	BLIGHTED_ENTANGLE_SACK(false, 24613, EARTH_RUNE, WATER_RUNE, NATURE_RUNE),
	BLIGHTED_SURGE_SACK(false, 26705, AIR_RUNE, WATER_RUNE, EARTH_RUNE, FIRE_RUNE, WRATH_RUNE,
			BLOOD_RUNE),
	BLIGHTED_TELEBLOCK_SACK(false, 24615, CHAOS_RUNE, DEATH_RUNE, LAW_RUNE),
	BLIGHTED_VENGEANCE_SACK(false, 24621, EARTH_RUNE, SOUL_RUNE, DEATH_RUNE),
	BLIGHTED_ANCIENT_ICE_SACK(false, 24607, WATER_RUNE, CHAOS_RUNE, DEATH_RUNE, BLOOD_RUNE);
